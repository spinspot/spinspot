...
export const getBookingsQueryDefinition = eventDefinition
  .partial();
export type TGetBookingsQueryDefinition = z.infer<typeof getBookingsQueryDefinition>;

export const getBookingParamsDefinition = eventDefinition.pick({ _id: true });
export type TGetBookingParamsDefinition = z.infer<typeof getBookingParamsDefinition>;
...
export const updateBookingParamsDefinition = eventDefinition.pick({ _id: true });
