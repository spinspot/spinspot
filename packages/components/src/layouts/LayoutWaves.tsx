    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="sm:hidden">
        <svg
          ...
          viewBox="0 0 411 211"
          fill="none"
          className="text-primary absolute left-0 top-[-60px] z-30"
        >
          <path
        ...
        <svg
          ...
          viewBox="0 0 411 446"
          fill="none"
          className="text-neutral absolute left-0 top-[-85px] z-20 flex-shrink-0"
        >
          <path
      ...
      <div className="hidden sm:block">
        <svg
          ...
          fill="none"
          className="text-primary absolute left-0 top-[-85px] z-30"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          className="text-neutral absolute left-0 top-[-95px] z-20"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          className="text-primary absolute bottom-[-65px] left-0 z-10"
        >
          <path
