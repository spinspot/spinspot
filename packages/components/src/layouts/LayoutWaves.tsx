    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="sm:hidden">
        <svg
          ...
          viewBox="0 0 411 211"
          fill="none"
          className="text-primary absolute left-0 top-[-50px] z-30"
        >
          <path
        ...
        <svg
          ...
          viewBox="0 0 411 446"
          fill="none"
          className="text-neutral absolute left-0 top-[-75px] z-20 flex-shrink-0"
        >
          <path
        ...
        <svg
          ...
          viewBox="0 0 411 168"
          fill="none"
          className="text-primary absolute bottom-[-35px] left-0 z-10"
        >
          <path
      ...
      <div className="hidden sm:block">
        <svg
          ...
          fill="none"
          className="text-primary absolute left-0 top-[-30px] z-30"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          className="text-neutral absolute left-0 top-[-40px] z-20"
        >
          <path
        ...
        <svg
          ...
          fill="none"
          className="text-primary absolute bottom-[-30px] left-0 z-10"
        >
          <path
      ...
      <div className="absolute inset-0 z-40 flex items-center justify-center">
        <main className="mt-14 w-96 space-y-4 rounded-lg p-8 sm:mt-32">
          {children}
        </main>
      </div>
    </div>
