    ...
    <>
      {isSmallScreen ? (
        <div className="relative h-screen overflow-hidden">
          {/* Primer SVG (encima de todos) */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 411 211"
            fill="none"
            className="absolute left-0 top-[-50px] z-30"
          >
            <path
          ...
          {/* Segundo SVG (debajo del primero) */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 411 446"
            fill="none"
            className="absolute left-0 top-[-75px] z-20 flex-shrink-0"
          >
            <path
          ...
          {/* Tercer SVG (en la parte inferior) */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 411 168"
            fill="none"
            className="absolute bottom-[-20px] left-0 z-10"
          >
            <path
          ...
          <div className="absolute inset-0 z-40 flex items-center justify-center">
            <form className="mt-14 w-96 space-y-4 rounded-lg p-8">
              ...
              <button
                type="button"
                className="w-full rounded-md bg-red-500 px-4 py-2 font-semibold text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500"
              >
        ...
        <div className="relative h-screen">
          ...
          <svg
            ...
            fill="none"
            className="absolute left-0 top-[-20px] z-30"
          >
            <path
          ...
          <svg
            ...
            fill="none"
            className="absolute left-0 top-[-15px] z-20"
          >
            <path
          ...
          {/* Formulario centrado */}
          <div className="absolute inset-0 z-40 flex items-center justify-center">
            <form className="mt-32 w-96 space-y-4 rounded-lg p-8">
              <h2 className="mb-4 text-center text-2xl font-bold">
                Iniciar Sesión
              </h2>
              <div>
