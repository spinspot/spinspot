...
tournamentMatchRouter.get(
  "/:_id",
  tournamentMatchController.getTournamentMatch,
);
tournamentMatchRouter.post(
  "/",
  tournamentMatchController.createTournamentMatch,
);
tournamentMatchRouter.put(
  "/:_id",
