...
async function createTournamentMatch(req: Request, res: Response) {
  const tournamentMatchData = createTournamentMatchInputDefinition.parse(
    req.body,
  );
  const tournamentMatch =
    await tournamentMatchService.createTournamentMatch(tournamentMatchData);
...
async function getTournamentMatches(req: Request, res: Response) {
  ...
  const tournamentMatches =
    await tournamentMatchService.getTournamentMatches(query);
...
async function getTournamentMatch(req: Request, res: Response) {
  ...
  const tournamentMatch = await tournamentMatchService.getTournamentMatch(
    params._id,
  );
...
async function updateTournamentMatch(req: Request, res: Response) {
  ...
  const tournamentMatch = await tournamentMatchService.updateTournamentMatch(
    params._id,
    input,
  );
  return res.status(200).json(tournamentMatch);
